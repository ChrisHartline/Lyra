...
| D2 | Gate passed | `venv\Scripts\python -m pytest tests/test_digests.py -q` -> `.. [100%]`; full suite: `venv\Scripts\python -m pytest -q` -> `........................... [100%]`; daily + weekly digests publish with Type set, dated Personal/Professional/Corpus/Memories sections, and never-persist filtering |
| D5 | Planned | Phase 2 preview — assistant briefing assembly |
